    ...
    def _run_racon(self, fasta):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            try:
                ...
                print("RACON FAILED. Used first repeat as template.")
...
def main(args):
    ...
    tempfile.tempdir = os.environ["TMPDIR"] # for cluster submission change tmp directory to allow more space given by -l tmpspace variable
    print(tempfile.tempdir)
